...
export default function ProductModal({
  ...
  return (
    ...
    >
      <div
        className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto transform transition-all"
      ...
      >
        <div className="relative">
          ...
          <div className="grid md:grid-cols-2 gap-0">
            {/* Image Section */}
            <div className="relative bg-gradient-to-br from-amber-50 to-orange-50 dark:from-gray-700 dark:to-gray-800 h-64 md:h-auto">
              <img
                src={product.image}
                alt={product.name}
            ...
            <div className="p-6 md:p-8">
              <div className="mb-4">
                <span className="inline-block px-3 py-1 bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400 rounded-full text-sm font-semibold mb-3">
                  {product.category}
                </span>
              ...
              <div className="border-t-2 border-gray-100 dark:border-gray-700 pt-6">
