            ...
            {[
              {
                ...
                description: 'Handpicked finest dry fruits with uncompromised quality'
              },
              {
                icon: Leaf,
                title: '100% Natural',
              ...
              >
                <div className="w-20 h-20 bg-gradient-to-br from-amber-100 to-orange-100 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:from-amber-500 group-hover:to-orange-500 transition-all duration-300">
                  <feature.icon size={36} className="text-amber-600 group-hover:text-white transition-colors" />
                </div>
      ...
      <section className="py-20 bg-gradient-to-r from-amber-600 to-orange-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg mb-6 leading-relaxed text-amber-50">
            ...
            Every product is crafted with care, combining health, taste, and tradition into one.
          </p>
          <p className="text-lg leading-relaxed text-amber-50 mb-8">
            With premium packaging and uncompromised quality, Zouqly is not just about dry fruits —
            it's about shaping habits that nourish body and soul.
          </p>
          <button
